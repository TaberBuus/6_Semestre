...
ylabel('Vinkel servo motorens arm positioneres [ grader ]'); 
xlabel('Kraftpåvirkning udført af servo [ N ] '); 
plot (x100,y100);
ylim([0 100]);
grid('on');
set(gcf,'Position',[300 300 1000 600])
set(gca,'FontSize',13)
title('Sammenhæng mellem servo motorens arms positionering og trykpåvikning'); 
